              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Text(product.name, style: const TextStyle(fontSize: 16),maxLines: 2,),
                  ),
                  Container(
                    width: 235,
                  ...
                  Container(
                    width: 235,
                    padding: EdgeInsets.only(left: 10, top: 5),
                    child: Text('In Stock', style: const TextStyle(color: GlobalVariables.selectedNavBarColor, fontWeight: FontWeight.bold),maxLines: 2,),
                  ),
                ],
              )
            ],
